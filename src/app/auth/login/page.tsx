    ...
    <div className="min-h-screen bg-paper flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="card p-8 text-center">
          ...
          <p className="text-ink-tertiary text-sm mb-8 leading-relaxed">
            Sign in with your Google account to access the parent portal or admin dashboard.
          </p>

          <button
            onClick={handleGoogleLogin}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border transition-colors hover:bg-gray-50"
