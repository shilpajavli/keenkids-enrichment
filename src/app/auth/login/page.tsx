    ...
    <div className="min-h-screen bg-paper flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <p className="text-ink-tertiary text-sm mt-2 tracking-wide">Enrichment Program Parent Portal</p>
        </div>
        ...
        <div className="card p-8">
          {sent ? (
            ...
            <>
              <h2 className="font-serif text-2xl font-light text-ink mb-2">Welcome</h2>
              <p className="text-ink-tertiary text-sm mb-6">Sign in to access your child's portal</p>

              {/* Google — primary */}
              <button
                onClick={handleGoogleLogin}
                className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border transition-colors hover:bg-gray-50 mb-4"
